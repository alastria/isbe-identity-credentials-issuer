...
QR_EXPIRATION_TIME = int(os.environ.get("QR_EXPIRATION_TIME", 500))  # In seconds
QR_EMPLOYEE_EXPIRATION_TIME = int(os.environ.get("QR_EMPLOYEE_EXPIRATION_TIME", 2 * 24 * 60 * 60))  # In seconds
